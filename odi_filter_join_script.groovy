    ...
    try {
        ...
        try {
            ...
            for (int sheetNumber =0; sheetNumber<sheetNames.length; sheetNumber++){
                ...
                if(sourceDatastore != null && joinConditionList.size() != 0){
                ...
                }else if (sourceDatastore != null && filterConditionList.size() != 0) {
                        ...
                        println('target_ds:'+ target_ds)
                        println('target_model:'+ target_model)
                        println('join condition list ' + filterConditionList)
                }else{
